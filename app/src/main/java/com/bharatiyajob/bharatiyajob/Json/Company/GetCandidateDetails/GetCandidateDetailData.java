...
public class GetCandidateDetailData {
    ...
    public GetCandidateDetailData(String name, String mobile, String email, String id, String gender, String heighest_qualification, String work_experience, String state, String address, String membership_plan, String profile_pic, String resume, String skill) {
        this.name = name;
        this.mobile = mobile;
        this.email = email;
        this.id = id;
